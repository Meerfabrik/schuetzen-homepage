...
export async function generateMetadata({ params }: Props) {
  return {
    title: `Jungkönig:innen ${params.jahrzehnt}`,
    description: `Bilder der Jungkönig:innen aus den ${params.jahrzehnt} Jahren.`,
  };
}
  ...
  return (
    <>
      ...
      <section className="section" style={{ paddingTop: "4.5rem", paddingBottom: "4.5rem" }}>
        <div className="container">
          <Link href="/galerie/jungkoenige" className={styles.backLink}>
            ← Alle Jahrzehnte
          </Link>
