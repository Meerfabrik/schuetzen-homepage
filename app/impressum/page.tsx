...
export const metadata = {
  title: "Impressum",
  description: "Impressum der St. Sebastianus-Schützenbruderschaft Büderich von 1567 e.V.",
};
      ...
      <section className="section">
        <div className={styles.content}>
          <address className={styles.address}>
            <strong>Verantwortlich für diese Internetseiten ist:</strong>
            St. Sebastianus-Schützenbruderschaft Büderich von 1567 e.V.<br />
            Der Vorstand<br />
            c/o Patrick Wirtz<br />
            Geschäftsstelle Moerser Str. 52<br />
            40667 Meerbusch
          </address>

          <div className={styles.programmierung}>
            <strong>Programmierung der Website</strong>
            Meerfabrik<br></br>
            c/o Nikolas Gross<br></br>
            <a href="https://meerfabrik.de" target="_blank" rel="noopener noreferrer">https://www.meerfabrik.de</a>
          </div>
